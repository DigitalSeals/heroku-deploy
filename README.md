...
| addons                      | false    | Array of heroku addons converted to JSON string                                                                                                                                                     | \[{name: "heroku-redis:free"}]                        |
| justCreate                  | false    | Set to true if you want the action to just create and configure heroku app and nothing else                                                                                                         | true or false                                         |
